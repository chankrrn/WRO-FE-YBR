...
DEFAULTS = {
    ...
    # Drive speed 100 -> this many mm/s. 700 through the original gearing;
    # 390 MEASURED with a tape after the 16:28 reduction was fitted (700mm in
    # 3.0s at command 60), which is within 3% of the 400 the ratio predicts.
    # Re-measure it the same way if the drivetrain changes again:
